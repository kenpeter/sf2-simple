...
class StreetFighterCustomWrapper(gym.Wrapper):
    """Simple Street Fighter wrapper - EXACTLY like old working code"""

    def __init__(self, env, reset_round=True, rendering=False, max_episode_steps=5000):
        super(StreetFighterCustomWrapper, self).__init__(env)
        self.env = env

        # Frame stacking - 9 frames with simple approach
        self.num_frames = 9  # 9 frames for more temporal information
    ...
    def _stack_observation(self):
        ...
        # Simple concatenation - let Python handle memory
    ...
    def reset(self, **kwargs):
        ...
        # Initialize frame stack - SIMPLE like old code
